...
// interacting with the knirvchain-transaction-sdk API. You should not instantiate
...
// (KNIRVCHAIN_TRANSACTION_SDK_API_KEY, KNIRVCHAIN_TRANSACTION_SDK_BASE_URL). This
// should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("KNIRVCHAIN_TRANSACTION_SDK_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("KNIRVCHAIN_TRANSACTION_SDK_API_KEY"); ok {
...
// environment (KNIRVCHAIN_TRANSACTION_SDK_API_KEY,
// KNIRVCHAIN_TRANSACTION_SDK_BASE_URL). The option passed in as arguments are
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.Chain = NewChainService(opts...)
	r.Block = NewBlockService(opts...)
	r.Transaction = NewTransactionService(opts...)
	r.TxnPool = NewTxnPoolService(opts...)
