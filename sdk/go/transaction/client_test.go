...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Chain.Get(context.Background())
	if userAgent != fmt.Sprintf("KnirvchainTransactionSDK/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Chain.Get(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Chain.Get(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Chain.Get(deadlineCtx)
		if err == nil {
